...
###EPG INSERTS HERE###
loader = QuokkaBinLoader(r'Z:\cycle\current\data\histserv\DAQ_2025-02-23T13-31-43\DATASET_0\EOS.bin', 900)
...
loader.setCenter(centerX = 90.9419, centerY = 93.5877) # center dose not affect resulting nexus-files, this is only for visualization within GumTree
...
loader.setEqualTimeBins(5)                 # 600 seconds time bins
###EPG ADDED SECTIONS HERE###
...
loader.exportDatasets(r'W:\data\proposal\00105\2025\18876_Henderson\EVENT MODE BINNED DATA\QKK0070015.nx.hdf')
