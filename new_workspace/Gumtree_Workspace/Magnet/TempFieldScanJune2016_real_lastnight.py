...
#        driveAtt(attList[i])
        ...
        sics.drive('ma1_setpoint', value)
        log('waiting for field to settle')
        log('driving tc1_driveable=' +  str(57.25))
        sics.drive('tc1_driveable', 57.25)
        sleep(600)
        fields = pack[1]
        for j in xrange(len(fields)):
            field = fields[j]
...
tempFieldList_FC = [
                 (225,[57.25,57,56.75,56.5,56.25,56,55.75,55.5,55.25,55]),
                 ]
...
scan_temp_field(tempFieldList, mode, preset_E, tempSettleTime, fieldSettleTime)
...
scan_temp_field_ZFC_RE(tempFieldList_W, mode, preset, tempSettleTime, fieldSettleTime)
scan_temp_field_FW_RE(tempFieldList_W, mode, preset, tempSettleTime, fieldSettleTime)
scan_temp_field_FW_E(tempFieldList_W, mode, preset, tempSettleTime, fieldSettleTime)
