...
tempFieldList_ZFC = [
                  (56.5,  #temperature 2
                    (
                     [170, [0,125,250,375,500,625,750,875,1000,]],
                    )
                  )
                 ]
...
scan_temp_field(tempFieldList_ZFC, mode, preset, tempSettleTime, fieldSettleTime)
scan_temp_field_FW(tempFieldList, mode, preset, tempSettleTime, fieldSettleTime)
