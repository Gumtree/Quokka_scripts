...
###EPG INSERTS HERE###
#loader = QuokkaBinLoader(r'Z:\cycle\current\data\histserv\DAQ_2025-11-20T11-10-16\DATASET_0\EOS.bin', 10800)
loader = QuokkaBinLoader(r'Z:\cycle\167\data\histserv\DAQ_2025-11-25T18-04-42\DATASET_0\EOS.bin', 43213)
...
###EPG ADDED SECTIONS HERE###
#loader.setManualTimeBins([30,90,150,210,270,330,390,450,510,570,630,690,750,810,870,930,990,1050,1110,1170,1230,1290,1350,1410,1470,1530,1590,1650,1710,1770,1830]) # new bin at 500, 3000 and 5000 seconds
loader.setManualTimeBins([600,1800,3000,4200,5400,6600,7800,9000,10200,11400,12600,13800,15000,16200,17400,18600,19800,21000,22200,23400,24600,25800,27000,28200,29400,30600,31800,33000,34200,35400,36600,37800,38400])
...
loader.exportDatasets(r'W:\data\proposal\00105\2025\17092_Xu\EVENT MODE BINNED DATA\QKK0082610.nx.hdf')
