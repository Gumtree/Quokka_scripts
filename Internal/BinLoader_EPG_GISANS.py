...
###EPG INSERTS HERE###
loader = QuokkaBinLoader(r'Z:\cycle\170\data\histserv\DAQ_2026-03-12T23-02-38\DATASET_0\EOS.bin', 50400)
...
loader.setCenter(centerX = 99.8823, centerY = 96.7431) # center dose not affect resulting nexus-files, this is only for visualization within GumTree
...
#loader.setEqualTimeBins(3600)                 # 600 seconds time bins
###EPG ADDED SECTIONS HERE###
loader.setManualTimeBins([0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330, 360, 390, 420, 450, 480, 510, 540, 570, 600, 900, 1000, 1600, 2200, 2800, 3400, 4000, 4600, 5200, 5800, 6400, 7000, 7600, 8200, 8800, 9400, 10000, 10600, 11200, 11800, 12400, 13000, 13600, 14200, 14800, 18400, 22000, 25600, 29200, 32800, 36400, 40000, 43600, 47200, 50800, 54400, 58000, 61600, 65200, 68800, 72400, 76000, 79600, 83200, 86800, 90400, 94000]) # new bin at 500, 3000 and 5000 seconds
...
loader.exportDatasets(r'W:\data\proposal\00105\2026\22692_Megroz_GISANS\EVENT MODE BINNED DATA\QKK0087497.nx.hdf')
