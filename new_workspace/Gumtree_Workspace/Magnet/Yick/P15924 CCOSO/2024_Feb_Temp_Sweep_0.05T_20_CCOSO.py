...
newfile HISTOGRAM_XY
drive tc1_driveable 40.5
drive tc1_driveable2 40.5
wait 10
histmem start block
save
histmem stop
...
newfile HISTOGRAM_XY
drive tc1_driveable 41.5
drive tc1_driveable2 41.5
wait 10
histmem start block
save
histmem stop
...
newfile HISTOGRAM_XY
drive tc1_driveable 42.5
drive tc1_driveable2 42.5
wait 10
histmem start block
save
histmem stop
...
newfile HISTOGRAM_XY
drive tc1_driveable 43.5
drive tc1_driveable2 43.5
wait 10
histmem start block
save
histmem stop
...
newfile HISTOGRAM_XY
drive tc1_driveable 44.5
drive tc1_driveable2 44.5
wait 10
histmem start block
save
histmem stop
...
newfile HISTOGRAM_XY
drive tc1_driveable 45.5
drive tc1_driveable2 45.5
wait 10
histmem start block
save
histmem stop
