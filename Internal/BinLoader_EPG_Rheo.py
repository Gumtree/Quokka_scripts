...
###EPG INSERTS HERE###
loader = QuokkaBinLoader(r'Z:\cycle\current\data\histserv\DAQ_2025-04-02T09-08-34\DATASET_0\EOS.bin', 3480)
...
loader.setCenter(centerX = 90.7169, centerY = 96.3379) # center dose not affect resulting nexus-files, this is only for visualization within GumTree
...
#loader.setEqualTimeBins(10)                 # 600 seconds time bins
###EPG ADDED SECTIONS HERE###
loader.setManualTimeBins([150, 330, 480, 660, 810, 990, 1140, 1320, 1470, 1650, 1800, 1980, 2130, 2310, 2460, 2640, 2790, 2970, 3120, 3300, 3450]) # new bin at 500, 3000 and 5000 seconds
...
loader.exportDatasets(r'W:\data\proposal\00105\2025\16864_Lauko\EVENT MODE DATA\QKK0070841.nx.hdf')
