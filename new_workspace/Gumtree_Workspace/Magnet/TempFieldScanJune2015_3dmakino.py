...
def scan_temp_field_3d(fieldList, mode, preset, tempSettleTime = 1, fieldSettleTime = 1):
#    for wavelength in wavelengthList:
    for i in xrange(len(fieldList)):
        pack = fieldList[i]
#        driveAtt(attList[i])
...
tempFieldList = [
                 (57.5,  #temperature 1
                    (
                     [170, [0,1000,2000,3000,0,-1000,-2000,-3000]],
                    )
                  )
                 ]
tempFieldList_3d = [
...
scan_temp_field_3d(tempFieldList_3d, mode, preset_3d, tempSettleTime, fieldSettleTime)
