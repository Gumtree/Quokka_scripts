...
directory = r'W:\data\proposal\00105\2024\November2024_tasks\wavelength_after_tilt_adjust_24Nov_22'
...
def run():
	...
	while x <= 4200:
		...
		saveHM('TOF_NVS40_15971_m5tilt_ga_apx2p5_80Hz_att0_postTiltAdjust' + str(x) + '.hdf')
		x = x + 1000
